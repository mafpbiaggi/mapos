...
class Mapos_model extends CI_Model {
    ...
    function pesquisar($termo){
        ...
        // buscando os
        $this->db->distinct();
        $this->db->select('a.idOs, a.status, a.dataInicial, a.dataFinal, b.nomeCliente, a.descricaoProduto');
        $this->db->from('os as a');
        $this->db->join('clientes as b', 'a.clientes_id = b.idClientes', 'inner');
        $this->db->like('b.nomeCliente',$termo);
        $this->db->or_like('a.descricaoProduto',$termo);
        $this->db->or_like('a.idOs',$termo);
    ...
    function getOsAbertas(){
        ...
        //$this->db->limit(10); Limite de resultados retirado em 16-09-2015
    ...
    public function addEmitente($nome, $cnpj, $ie, $logradouro, $numero, $bairro, $cidade, $uf, $telefone, $whatsapp, $email, $logo){
    ...
    public function editEmitente($id, $nome, $cnpj, $ie, $logradouro, $numero, $bairro, $cidade, $uf, $telefone, $whatsapp ,$email){
