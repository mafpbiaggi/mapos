...
class Mapos extends CI_Controller {
    ...
    public function cadastrarEmitente() {
        ...
        $this->form_validation->set_rules('whatsapp','WhatsApp','required|xss_clean|trim');
        ...
        if ($this->form_validation->run() == false) {
            ...
            $retorno = $this->mapos_model->addEmitente($nome, $cnpj, $ie, $logradouro, $numero, $bairro, $cidade, $uf, $telefone, $whatsapp, $email, $logo);
            if($retorno){
    ...
    public function editarEmitente() {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $retorno = $this->mapos_model->editEmitente($id, $nome, $cnpj, $ie, $logradouro, $numero, $bairro, $cidade, $uf, $telefone, $whatsapp, $email);
            if($retorno){
