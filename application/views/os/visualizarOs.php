                ...
                <div class="invoice-content">
                            ...
                            <tbody>
                                ...
                                <?php } else { ?>
                                    <tr>
                                        ...
                                        <td style="width: 20%; text-align: right;">O.S.: <span><?php echo $result->idOs ?></span></br></br><span style="font-size: 12px;">Entrada: <?php echo formatDateToView($result->dataInicial) ?></br>Saída: <?php echo formatDateToView($result->dataFinal) ?></span></td>
                                    </tr>
                                <?php } ?>
                            </tbody>
                        </table>
                    ...
                    <div style="margin-top: 0; padding-top: 0; margin-bottom: 0; padding-bottom: 0">
                        ...
                        <?php if (($totalProdutos + $totalServico) != 0) { ?>
                            <h4 style="text-align: right">Valor Total: R$ <?php echo number_format($totalProdutos + $totalServico, 2, ',', '.');
                                                                        } ?></h4>
                    </div>
                </div>
            </div>
...
<script type="text/javascript" src="<?php echo base_url() ?>assets/js/os/imprimir.js"></script>
