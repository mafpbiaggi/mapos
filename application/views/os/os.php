            ...
            <table class="table table-bordered ">
                ...
                <tbody>
                    <?php foreach ($results as $r) {
                        ...
                        echo '<td>' . formatDateToView($r->dataInicial) . '</td>';
                        echo '<td>' . $r->status . '</td>';
                        echo '<td>' . $r->descricaoProduto . '</td>';
                        echo '<td>' . formatDateToView($r->dataFinal) . '</td>';
                        echo '<td>';
...
<script type="text/javascript" src="<?php echo base_url() ?>assets/js/os/os.js"></script>
