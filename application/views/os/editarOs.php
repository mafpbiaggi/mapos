    ...
    <div class="span12">
        <div class="widget-box">
            <div class="widget-title">
                ...
                <h5>Editar OS</h5>
                <div class="buttons">
                    <a href="<?php echo base_url() ?>index.php/os/visualizar/<?php echo $result->idOs; ?>" class="btn btn-mini btn-inverse"><i class="icon-eye-open"></i> Visualizar OS</a>
                </div>
            </div>
                                ...
                                <form action="<?php echo current_url(); ?>" method="post" id="formOs">
                                    ...
                                    <div class="span12" style="padding: 1%; margin-left: 0">
                                        ...
                                        <div class="span3">
                                            ...
                                            <input id="dataInicial" class="span12 datepicker" type="text" name="dataInicial" value="<?php echo formatDateToView($result->dataInicial) ?>" />
                                        </div>
                                        <div class="span3">
                                            <label for="dataFinal">Data de Saída</label>
                                            <input id="dataFinal" class="span12 datepicker" type="text" name="dataFinal" value="<?php echo formatDateToView($result->dataFinal) ?>" />
                                        </div>
                                        <div class="span3">
                                    ...
                                    <div class="span12" style="padding: 1%; margin-left: 0">
                                        ...
                                        <div class="span6">
                                            <label for="laudoTecnico">Laudo Técnico / Orçamento</label>
                                            <textarea class="span12" name="laudoTecnico" id="laudoTecnico" cols="30" rows="5"><?php echo $result->laudoTecnico ?></textarea>
                                        </div>
                                    </div>
                                    <div class="span12" style="padding: 1%; margin-left: 0">
                                        <div class="span6">
                                            <label for="obsInterno">Observações Internas</label>
                                            <textarea class="span12" name="obsInterno" id="ObsInterno" cols="30" rows="5"><?php echo $result->obsInterno ?></textarea>
                                        </div>
                                ...
                                <div class="span12 well" style="padding: 1%; margin-left: 0">
                                    <form id="formProdutos" action="<?php echo base_url() ?>index.php/os/adicionarProduto" method="post">
                                        <div class="span6">
                                            ...
                                            <input type="hidden" name="descriProd" id="descriProd" />
                                        ...
                                        <div class="span2">
                                            ...
                                            <input type="text" class=span12 id="descProd_os" name="descProd_os" placeholder="Desconto" />
                                        </div>
                                        <div class="span2">
                                    ...
                                    <table class="table table-bordered" id="tblProdutos">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($produtos as $p) {
                                                ...
                                                echo '<td style="text-align: right">R$ ' . number_format($p->precoProd_os, 2, ',', '.') . '</td>';
                                                echo '<td style="text-align: right">R$ ' . number_format($p->descProd_os, 2, ',', '.') . '</td>';
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: right"><strong>R$ <?php echo number_format($total, 2, ',', '.'); ?><input type="hidden" id="total-venda" value="<?php echo number_format($total, 2); ?>"></strong></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                                ...
                                <div class="span12 well" style="padding: 1%; margin-left: 0">
                                    <form id="formServicos" action="<?php echo base_url() ?>index.php/os/adicionarServico" method="post">
                                        <div class="span6">
                                            ...
                                            <input type="hidden" name="descriServico" id="descriServico" />
                                            <label for="servico">Serviço</label>
                                            <input type="text" class="span12" name="servico" id="servico" placeholder="Digite o nome do serviço" />
                                        </div>
                                        <div class="span2">
                                            <label for="quantServico">Quantidade</label>
                                            <input type="text" placeholder="Quantidade" id="quantServico" name="quantServico" class="span12" />
                                        </div>
                                        <div class="span2">
                                            <label for="descServico">Desconto</label>
                                            <input type="text" class="span12" id="descServico" name="descServico" placeholder="Desconto" />
                                        </div>
                                        <div class="span2">
                                            <label for="">&nbsp</label>
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($servicos as $s) {
                                                $preco = $s->precoSrv_os;
                                                $descSrv = $s->descSrv_os;
                                                $total = $total + $s->subTotal;
                                                echo '<tr>';
                                                echo '<td>' . $s->nome . '</td>';
                                                echo '<td style="text-align: center">' . $s->quantServico . '</td>';
                                                echo '<td style="text-align: right">R$ ' . number_format($s->precoSrv_os, 2, ',', '.') . '</td>';
                                                echo '<td style="text-align: right">R$ ' . number_format($s->descSrv_os, 2, ',', '.') . '</td>';
                                            ...
                                            <tr>
                                                <td colspan="4" style="text-align: right"><strong>Total:</strong></td>
                                                <td style="text-align: right"><strong>R$ <?php echo number_format($total, 2, ',', '.'); ?><input type="hidden" id="total-servico" value="<?php echo number_format($total, 2); ?>"></strong></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                                ...
                                <div class="span12 well" style="padding: 1%; margin-left: 0" id="form-anexos">
                                    <form id="formAnexos" enctype="multipart/form-data" action="javascript:;" accept-charset="utf-8" s method="post">
                                        <div class="span10">
                                            ...
                                            <input type="file" class="span12" id="userfile" name="userfile[]" multiple="multiple" size="20" />
                                        </div>
                                        <div class="span2">
                                            <label for="">.</label>
...
<div id="modal-faturar" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <form id="formFaturar" action="<?php echo current_url() ?>" method="post">
        ...
        <div class="modal-body">
            ...
            <div class="modal-footer">
                <button class="btn" data-dismiss="modal" id="btn-cancelar-faturar">Cancelar</button>
...
<script type="text/javascript" src="<?php echo base_url() ?>assets/js/os/anexos.js"></script>
<script type="text/javascript" src="<?php echo base_url() ?>assets/js/os/faturar.js"></script>
<script type="text/javascript" src="<?php echo base_url() ?>assets/js/os/produtos.js"></script>
<script type="text/javascript" src="<?php echo base_url() ?>assets/js/os/servicos.js"></script>
