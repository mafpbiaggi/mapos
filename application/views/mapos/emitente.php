...
<div id="modalCadastrar" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  ...
  <div class="modal-body">
                    ...
                    <div class="control-group">
                        <label for="descricao" class="control-label"><span class="required">WhatsApp*</span></label>
                        <div class="controls">
                ...
                <table class="table table-bordered">
                    <tbody>
                        <tr>
                            ...
                            <td> <span style="font-size: 20px; "> <?php echo $dados[0]->nome; ?> </span> </br><span><?php echo 'CNPJ: '.$dados[0]->cnpj; ?> </br> <?php echo $dados[0]->rua.', nº:'.$dados[0]->numero.', '.$dados[0]->bairro.' - '.$dados[0]->cidade.' - '.$dados[0]->uf; ?> </span> </br> <span> E-mail: <?php echo $dados[0]->email.' | Fone: '.$dados[0]->telefone.' | WhatsApp: '.$dados[0]->whatsapp; ?></span></td>
                        </tr>
                    </tbody>
                </table>
...
$(document).ready(function(){
    ...
    $("#formCadastrar").validate({
      ...
      messages:{
         ...
         whatsapp: {required:'Campo Requerido.'},
