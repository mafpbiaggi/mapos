...
<div class="row-fluid" style="margin-top: 0">
    ...
    <div class="span12" style="margin-left: 0">        
        <div class="widget-box">
            <div class="widget-title"><span class="icon"><i class="icon-signal"></i></span><h5>Ordens de Serviço Em Orçamento</h5></div>
            <div class="widget-content">
                <table class="table table-bordered">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        ...
                        if($ordens != null){
                            foreach ($ordens as $o) {
                                echo '<tr>';
                                echo '<td style="text-align: center">'.$o->idOs.'</td>';
                                echo '<td>'.$o->status.'</td>';
        ...
        <div class="widget-box">
            ...
            <div class="widget-content">
                <div class="row-fluid">           
                    <div class="span12">
                        <ul class="site-stats">
                            <li class="bg_lh"><a href="<?php echo base_url()?>index.php/clientes"/><i class="icon-group"></i> <strong><?php echo $this->db->count_all('clientes');?></strong> <small>Clientes</small></li>
                            <li class="bg_lh"><a href="<?php echo base_url()?>index.php/produtos"/><i class="icon-barcode"></i> <strong><?php echo $this->db->count_all('produtos');?></strong> <small>Produtos </small></li>
                            <li class="bg_lh"><a href="<?php echo base_url()?>index.php/os"/><i class="icon-tags"></i> <strong><?php echo $this->db->count_all('os');?></strong> <small>Ordens de Serviço</small></li>
                            <li class="bg_lh"><a href="<?php echo base_url()?>index.php/servicos"/><i class="icon-wrench"></i> <strong><?php echo $this->db->count_all('servicos');?></strong> <small>Serviços</small></li>
