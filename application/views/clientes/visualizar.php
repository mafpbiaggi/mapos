        ...
        <div id="tab1" class="tab-pane active" style="min-height: 300px">
            ...
            <div class="accordion" id="collapse-group">
                                ...
                                <div class="accordion-heading">
                                    <div class="widget-title">
                                        <a data-parent="#collapse-group" href="#collapseGOne" data-toggle="collapse">
                                            <span class="icon"><i class="icon-list"></i></span><h5>Dados Pessoais / Empresa</h5>
                                        </a>
                                    </div>
                                </div>
                                    ...
                                    <div class="widget-content">
                                        <table class="table table-bordered">
                                            <tbody>
						                        ...
						                        <tr>
                                                    <td style="text-align: right; width: 30%"><strong>Data de Nascimento</strong></td>
                                                    <td><?php echo date('d/m/Y', strtotime($result->dataNascimento)); ?></td>
                                                </tr>
                                                <tr>
						...
						<tr>
                                                ...
                                                <tr>
                                                    <td style="text-align: right"><strong>Celular 1</strong></td>
                                                    <td><?php echo $result->celular ?></td>
                                                </tr>
						<tr>
                                                    <td style="text-align: right"><strong>Celular 2</strong></td>
