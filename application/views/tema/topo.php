...
<link rel="stylesheet" href="<?php echo base_url();?>assets/css/top.css" />
<link rel="shorcut icon" href="<?php echo base_url();?>img/favicon.ico" type="image/x-icon" />
...
<!--Header-part-->
<div id="header" class="header-topo">
  <!--<h1><a href="">Map OS</a></h1>-->
  <img class="logo-topo" alt="logo" src="<?php echo base_url();?>assets/img/logo.png" />
</div>
<!--close-Header-part--> 
